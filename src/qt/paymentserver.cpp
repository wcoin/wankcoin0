...
const QString BITCOIN_IPC_PREFIX("wankcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click wankcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start wankcoin: click-to-pay handler");
    else
...
{
    // clicking on wankcoin: URLs creates FileOpen events on the Mac:
